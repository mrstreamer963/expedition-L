...
- [x] 1.1 Написать тест: colonist idle → assigned → moving → working → done (движение по пути, занятие тайла)
- [x] 1.2 Написать тест: colonist ест еду (находит еду, идёт, consuming, еда удаляется, hunger +40)
- [x] 1.3 Написать тест: colonist спит в кровати (находит кровать, идёт, 10s, sleep +60)
- [x] 1.4 Написать тест: colonist строит здание (task в очереди, назначается, идёт, строит 0.5s, здание появляется)
- [x] 1.5 Написать тест: движение блокируется занятым тайлом назначения
- [x] 1.6 Написать тест: JobSystem назначает build task ближайшему idle колонисту
- [x] 1.7 Написать тест: приоритет голода над стройкой
...
- [x] 3.7 Прогнать тесты из секции 1 (зелёные?)
...
- [x] 9.1 `npm test` — все тесты зелёные
- [x] 9.2 `npm run build` — компиляция без ошибок
- [x] 9.3 Ручной тест: новая игра, колонисты едят и спят
- [x] 9.4 Ручной тест: стройка стены, кровати, еды
- [x] 9.5 Ручной тест: загрузка старого сейва (если есть)
