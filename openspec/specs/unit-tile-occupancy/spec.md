...
Track tile occupancy for colonists based on their state (idle/working/walking) and use occupancy information to guide pathfinding and movement decisions.
